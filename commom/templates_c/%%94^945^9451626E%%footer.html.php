...
home" class="link-rodape">Box para banheiros</a></li>
                    <li class="linha-rodape"> | </li>
                    <li class="linha-rodape"><a href="<?php echo $this->_tpl_vars['URL']; ?>
quem-somos" class="link-rodape">Vidros</a></li>
                    <li><div class="row"></div></li>
                    <li class="linha-rodape"><a href="<?php echo $this->_tpl_vars['URL']; ?>
produtos" class="link-rodape">Espelhos</a></li>
                    <li class="linha-rodape"> | </li>
                    <li class="linha-rodape"><a href="<?php echo $this->_tpl_vars['URL']; ?>
projetos" class="link-rodape">Portas</a></li>
                    <li><div class="row"></div></li>
                    <li class="linha-rodape"><a href="<?php echo $this->_tpl_vars['URL']; ?>
promocao" class="link-rodape">Divisórias</a></li>
                    <li class="linha-rodape"> | </li>
                    <li class="linha-rodape"><a href="<?php echo $this->_tpl_vars['URL']; ?>
fale-conosco" class="link-rodape">Janelas</a></li>
                    <li><div class="row"></div></li>
                    <li class="linha-rodape"><a href="<?php echo $this->_tpl_vars['URL']; ?>
promocao" class="link-rodape">Guarda Corpo</a></li>
                    <li class="linha-rodape"> | </li>
                    <li class="linha-rodape"><a href="<?php echo $this->_tpl_vars['URL']; ?>
fale-conosco" class="link-rodape">Coberturas</a></li>
                    <li><div class="row"></div></li>
                    <li class="linha-rodape"><a href="<?php echo $this->_tpl_vars['URL']; ?>
promocao" class="link-rodape">Móveis</a></li>
                    <li class="linha-rodape"> | </li>
                    <li class="linha-rodape"><a href="<?php echo $this->_tpl_vars['URL']; ?>
fale-conosco" class="link-rodape">Fachadas</a></li>
                    <li><div class="row"></div></li>
                    <li class="linha-rodape"><a href="<?php echo $this->_tpl_vars['URL']; ?>
promocao" class="link-rodape">Lousa</a></li>
                    <li class="linha-rodape"> | </li>
                    <li class="linha-rodape"><a href="<?php echo $this->_tpl_vars['URL']; ?>
fale-conosco" class="link-rodape">Biombo</a></li>
                </ul>
            </div>
