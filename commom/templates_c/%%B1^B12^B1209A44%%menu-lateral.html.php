<?php /* Smarty version 2.6.12, created on 2015-12-09 12:37:02
...
projeto">Hotel Enseada</a></li>
            <li class="txt-interna abre-sub-lateral"><a href="<?php echo $this->_tpl_vars['URL']; ?>
projeto">Residencial Arujá</a></li>
            <li class="txt-interna abre-sub-lateral"><a href="<?php echo $this->_tpl_vars['URL']; ?>
projeto">Academia Nível A</a></li>
            <li class="txt-interna abre-sub-lateral"><a href="<?php echo $this->_tpl_vars['URL']; ?>
projeto">Academia Cia Água</a></li>
            <li class="txt-interna abre-sub-lateral"><a href="<?php echo $this->_tpl_vars['URL']; ?>
projeto">Clínica bem viver</a></li>
        </ul>
    </div>
    <!-- Mobile -->
    <form action="<?php echo $this->_tpl_vars['URL']; ?>
