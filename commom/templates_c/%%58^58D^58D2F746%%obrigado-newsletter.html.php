<?php /* Smarty version 2.6.12, created on 2015-12-08 17:24:38
         compiled from obrigado-newsletter.html */ ?>
<!DOCTYPE HTML>
<html lang="pt-br">
<head>
	<meta charset="utf-8">
            ...
            <section class="conteudo">
                <article class="bloco-conteudo-interna">
                    <div class="col-xs-12 col-sm-7 col-md-7 mg-bt-20">
                        <h1 class="titulo-interna">NEWSLETTER</h1>
                        <p class="txt-interna">Obrigado, em breve entraremos em contato!</p>
                    </div>
