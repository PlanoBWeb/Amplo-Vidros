<?php /* Smarty version 2.6.12, created on 2015-12-07 12:29:21
         compiled from produtos4.html */ ?>
<!DOCTYPE HTML>
<html lang="pt-br">
<head>
    <meta charset="utf-8">
...
unset($_smarty_tpl_vars);
 ?>
                    <div class="col-xs-12 col-sm-9 col-md-9">
                        ...
                        <h1 class="titulo-interna">espelhos • Moldura</h1><br>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-3 col-md-3 bloco-img-tipos">
                                <a class="img" href="<?php echo $this->_tpl_vars['URL']; ?>
commom/img/">
                                    <img class="img-produtos-tipos" src="<?php echo $this->_tpl_vars['URL']; ?>
commom/img/produto1.jpg" alt="produto" title="produto">
...
produto" class="txt-interna">Decorativo</a></h2>
                            </div>
                            <div class="col-xs-12 col-sm-3 col-md-3 bloco-img-tipos">
                                <a class="img" href="<?php echo $this->_tpl_vars['URL']; ?>
commom/img/">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6 bloco-projetos-mobile">
                                <div class="mtlsr-images-for-lightbox">
                                    <div class="row pd-lt-10">
                                        <h3 class="txt-interna">Academia Nível A</h3>
                                    </div>
...
commom/img/lupa-produto.png" alt="Abrir" title="Abrir">
                                    ...
                                    <div class="row">
                                        <a href="<?php echo $this->_tpl_vars['URL']; ?>
produto" class="btn-default-padrao pull-right align-btn-projeto">Ver Projeto</a>
                                    </div>
                                </div> 
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6 bloco-projetos-mobile">
                                <div class="mtlsr-images-for-lightbox">
                                    <div class="row pd-lt-10">
                                        <h3 class="txt-interna">Academia Nível B</h3>
                                    </div>
                                    <ul class="projetos-lightbox">
                                        <li>
                                            <a href="<?php echo $this->_tpl_vars['URL']; ?>
